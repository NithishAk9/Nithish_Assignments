...
public class Treeset {
	public static void main(String[] args) {
		...
		s.add(new Employees("Arun", 123, 50000, "Dev"));
		s.add(new Employees("Santhosh", 456, 60000, "HR"));
		s.add(new Employees("Anil", 789, 30000, "Mgmt"));
		s.add(new Employees("Naveen", 111, 90000, "Mgmt"));
		s.add(new Employees("Chandu", 222, 10000, "Dev"));
